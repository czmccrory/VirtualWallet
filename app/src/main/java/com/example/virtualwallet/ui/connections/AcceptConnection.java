...
public class AcceptConnection extends DialogFragment {
    ...
    public AcceptConnection(String connectionID, String label) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage("Accept connection from: " + label + "?")
                ...
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        listener.onCancelConnectionClick(AcceptConnection.this);
                    }
                });
